    ...
    <section id="about" className="py-20 px-6 md:px-12 max-w-7xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 gap-12 items-center">
        <div className="space-y-6 text-lg text-slate-300 leading-relaxed">
          ...
          <p>
            My journey involves mastering the MERN stack, containerization with Docker, and cloud deployment on AWS. 
            I thrive in environments where I can solve complex problems and learn new technologies.
          </p>
        </div>
        <div className="grid grid-cols-2 gap-4">
          <Card className="text-center">
            <h3 className="text-3xl font-bold text-blue-400 mb-2">2026</h3>
