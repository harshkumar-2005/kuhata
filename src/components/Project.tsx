...
interface Project {
  ...
  tags: string[];
  github: string;
  icon: React.ReactNode; // Allows for SVGs, JSX, or strings
}
  ...
  const projects: Project[] = [
    {
      ...
      tags: ["TypeScript", "React", "Node.js", "MySQL", "Prisma", "Express"],
    ...
    },
    {
      ...
      desc: "Real-time weather application featuring geolocation services, 5-day forecasting, and a responsive dark-mode UI.",
      tags: ["React", "OpenWeather API", "Tailwind"],
      github: "https://github.com/harshkumar-2005/Weather-App",
      icon: (
