...
const App = () => {
  return (
    <div className="min-h-screen bg-[#0f172a] text-slate-200 font-sans selection:bg-blue-500 selection:text-white overflow-x-hidden relative">
      ...
      <svg className="fixed inset-0 w-full h-full z-0 pointer-events-none" viewBox="0 0 1920 1080" fill="none" xmlns="http://www.w3.org/2000/svg">
        <defs>
      ...
      <nav className="fixed top-6 left-1/2 transform -translate-x-1/2 w-[90vw] max-w-4xl z-50 bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl shadow-lg flex justify-between items-center px-8 py-4 animate-fade-in">
        <div className="text-2xl font-extrabold text-gradient tracking-tight">HT.</div>
        ...
        <a href="/harsh_resume.pdf" download className="px-5 py-2 text-base font-bold bg-gradient-to-r from-blue-400 to-purple-400 text-white rounded-full shadow hover:scale-105 transition-transform">
          Resume
        </a>
      </nav>
